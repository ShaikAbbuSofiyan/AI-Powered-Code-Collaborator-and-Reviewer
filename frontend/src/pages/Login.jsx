...
import {  setToken, setUser } from "../redux/authSlice.js";
      ...
      <main className="flex items-center justify-center p-6 sm:p-12 bg-background">
        <div className="w-full max-w-md animate-fade-in">
          <div className="lg:hidden flex items-center gap-2 mb-10">
            <div className="w-9 h-9 rounded-lg bg-gradient-primary grid place-items-center"><Code2 className="w-5 h-5"/></div>
          ...
          <form className="mt-10 space-y-5 " onSubmit={handleSignin}>
            <div className="space-y-2 space-x-5 flex flex-col ">
              ...
              <input id="email" type="email" placeholder="you@company.com" className="h-11 bg-gray-700 rounded-xl px-5 outline-violet-900 hover:outline-3"/>
            </div>
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                <label htmlFor="password" className="font-semibold">Password</label>
              </div>
              <input id="password" type="password" placeholder="••••••••" className="w-full h-11 bg-gray-700 rounded-xl px-5 outline-violet-900 hover:outline-3"/>
            </div>
          ...
          <p className="mt-8 text-sm text-muted-foreground text-center">
            Don't have an account? <a href="/signup" className="text-primary hover:text-cyan-300 font-medium ">Create Account</a>
          </p>
        </div>
      </main>
    </div>
